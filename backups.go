...
func (c *Client) BackupList(ctx context.Context, app string, addonID string) ([]Backup, error) {
	...
	if err != nil {
		return nil, errors.Wrap(ctx, err, "fail to get backup")
	}
...
func (c *Client) BackupCreate(ctx context.Context, app, addonID string) (*Backup, error) {
	...
	if err != nil {
		return nil, errors.Wrap(ctx, err, "fail to schedule a new backup")
	}
...
func (c *Client) BackupDownloadURL(ctx context.Context, app, addonID, backupID string) (string, error) {
	...
	if err != nil {
		return "", errors.Wrap(ctx, err, "fail to get backup archive")
	}
	...
	if err != nil {
		return "", errors.Wrap(ctx, err, "fail to decode backup archive")
	}
