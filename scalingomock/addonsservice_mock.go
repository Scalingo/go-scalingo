...
func (m *MockAddonsService) AddonProvision(arg0, arg1, arg2 string) (scalingo.AddonRes, error) {
	m.ctrl.T.Helper()
...
func (m *MockAddonsService) AddonUpgrade(arg0, arg1, arg2 string) (scalingo.AddonRes, error) {
	m.ctrl.T.Helper()
