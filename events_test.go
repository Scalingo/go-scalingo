...
func TestEventsList(t *testing.T) {
	...
	for msg, c := range eventsListCases {
		t.Run(msg, func(t *testing.T) {
			...
			apiMock.EXPECT().SubresourceList(gomock.Any(), appsResource, c.App, eventsResource, c.PaginationReq.ToURLValues(), gomock.Any()).Do(func(_ context.Context, _, _, _ string, _ any, res any) {
