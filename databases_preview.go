...
const databasesPreviewResource = "databases"
...
func (c *PreviewClient) DatabaseCreate(ctx context.Context, params DatabaseCreateParams) (DedicatedDatabase, error) {
	...
	err := c.parent.ScalingoAPI().ResourceAdd(ctx, databasesPreviewResource, params, &res)
	if err != nil {
...
func (c *PreviewClient) DatabasesList(ctx context.Context) ([]DedicatedDatabase, error) {
	...
	err := c.parent.ScalingoAPI().ResourceList(ctx, databasesPreviewResource, nil, &res)
	if err != nil {
...
// Currently, appID is the dedicated database identifier.
...
func (c *PreviewClient) DatabaseDestroy(ctx context.Context, appID string) error {
	dedicatedDatabase, err := c.searchDatabase(ctx, appID)
	if err != nil {
		return errors.Wrap(ctx, err, "destroy dedicated database")
	}
...
// Linear database search based on DatabasesList method.
